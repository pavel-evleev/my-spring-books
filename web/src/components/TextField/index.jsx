  ...
  render() {
    ...
    return (
      <div style={{ position: "relative", width: "fit-content", marginTop: "-14px" }}>
        <div style={{ position: "absolute", backgroundColor: "white", height: "34px", top: "33px", bottom: 0, right: 0, left: 0, borderRadius: "10px" }}></div>
        <div style={{ position: "absolute", top: "37px", right: "0" }}>
          {this.props.valid != null ?
            (this.props.valid ? this.state.success : this.state.error) : ''}</div>
        <TextField
